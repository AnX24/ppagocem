        ...
        <div class="enterbox">
          <div class="w-form">
              <div class="columns-7 w-row">
                ...
                <div class="w-col w-col-6"><input type="text" class="text-field-2 w-input" placeholder="Usuario" id="user"></div>
              </div>
              <div class="w-row">
                <div class="w-clearfix w-col w-col-6"><label  class="field-label-2">Password</label></div>
